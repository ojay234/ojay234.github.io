              ...
              <div className="product-list">
                {category.plants.map((plant) => (
                  <div className="product-card" key={plant.name}>
                    ...
                    <button
                      className={`add-to-cart-btn  product-button ${
                        findPlantName(plant.name) ? "added-to-cart" : ""
                      }`}
                      onClick={() => handleAddToCart(plant)}
                      disabled={findPlantName(plant.name)}
                    >
                      {findPlantName(plant.name)
                        ? "Added to Cart"
                        : "Add to Cart"}
                    </button>
                  </div>
